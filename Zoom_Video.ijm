/*
 * BACKBONE OF THIS IS NOT MINE. IT WAS MADE BY:
 ...
 * 
 * 
 * THIS VERSION: zoom_Video
 * edit from stn@stowers.org (2018)
 * Makes zoom compatible with RGB histology images for planarian anatomy ontology (PLANA)
 * please note this runs bicubic interpolation and should be considered qualitative.
 * old version has default enhance contrast- I removed this to work better with RGB images i.e. HISTOLOGY
*/
...
if(selectionType() ==0)
{
	...
	//print final height and width
	//print("nFinalW" + " " nFinalW);
	//print("nFinalH" + " " nFinalH);
	...
	//{		
		...
		//THIS IS WHAT'S THROWING OFF RGB IMAGES- DO USE FOR 8BIT
